...
- [x] **E2E тесты после рефакторинга** — **34/34 PASS** (Sprint 5). HMAC-SHA256 + новая схема sessions работает корректно.
- [x] **Удалить dev DB перед тестами** — каждый E2E тест использует изолированный tmpDir, dev DB не нужна.
